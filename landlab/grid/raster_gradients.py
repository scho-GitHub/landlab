...
from landlab.grid import node_and_link_gradients
...
def calc_grad_at_link(grid, node_values, out=None):
    ...
    LLCATS: LINF GRAD
    """
    grads = node_and_link_gradients.calc_diff_at_link(grid, node_values, out=out)
...
def calc_grad_at_active_link(grid, node_values, out=None):
    ...
    #                                                  out=out)
    grads = node_and_link_gradients.calc_diff_at_link(grid, node_values)
